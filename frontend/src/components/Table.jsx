...
export default function RecordsTable({ _records }) {

  const [rows, setRows] = useState(_records);
    ...
    <>
      ...
      >
        ...
        <DialogActions>
          ...
          <Button onClick={() => { handleDeleteClose(); deleteRecord(selectedRow._id) }} autoFocus>
            Ok
          </Button>
        </DialogActions>
      </Dialog>
